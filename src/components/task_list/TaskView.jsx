...
export default function TaskView(props) {
  ...
  dueDate = dueDate.isValid()
    ? dueDate.format(`h:mm A  dddd, MMM Do, YYYY `)
    : "";
  return (
    <div>
      <Card className={classes.root} raised>
        <CardActionArea
          ...
          classes={{
            focusVisible: classes.cardActionArea,
            focusHighlight: classes.cardActionArea,
          }}
        >
          <CardContent style={strikeThroughStyle}>
          ...
          >
            <Box ml={1}>
              <FormControlLabel
                ...
                label={completed ? "Done" : "Mark as Done"}
              />
            </Box>
            <IconButton
      ...
      <EditTaskDialog
        ...
        task={task}
        closeDialogHandler={closeEditDialog}
        open={open}
